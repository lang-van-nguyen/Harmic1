...
namespace Harmic1.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DataTh2Context context)
        {
            _context = context;
        }
        ...
        {
            var dataTh2Context = _context.TbProducts.Include(t => t.CategoryProduct);
            return View(await dataTh2Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Title,Alias,CategoryProductId,Description,Detail,Image,Price,PriceSale,Quantity,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,IsNew,IsBestSeller,UnitInStock,IsActive,Star")] TbProduct tbProduct)
        {
            ...
            {
                tbProduct.Alias = Harmic1.Utilities.Function.TitlesluGenerationAlias(tbProduct.Title);
